...
if(isset($_POST["btnsave"]))
    {
        $sqlinsert="INSERT INTO tender (tender_id,title,tender_type,currency,publish_date,bid_open_date,bid_close_date,bid_validity,status,create_by)
                        VALUES('".mysqli_real_escape_string($con,$_POST["txttender_id"])."',
                        '".mysqli_real_escape_string($con,$_POST["txttitle"])."',
                        '".mysqli_real_escape_string($con,$_POST["txttender_type"])."',
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <div class="i-checks pull-left">
                                                                                <label>
                                                                                <input type="radio" value="option1" name="a"> <i></i> Sales </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <div class="i-checks pull-left">
                                                                                <label>
                                                                                <input type="radio" checked="" value="option2" name="a"> <i></i> Procurement </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <!-- One Row End--> 
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <input type="text" name="txttender_id" id="txttender_id" class="form-control" required />
                                                            </div>
                                                            <!-- One Column End-->
                                                        </div>
                                                    </div>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">   
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="false" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlview="SELECT tender_id,title,bid_open_date,bid_close_date,status From tender";
