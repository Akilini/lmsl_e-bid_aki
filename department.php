...
if(isset($_POST["btnsave"]))
    {
        $sqlinsert="INSERT INTO department (department_id,department_name)
                        VALUES('".mysqli_real_escape_string($con,$_POST["txtdepartment_id"])."',
                        '".mysqli_real_escape_string($con,$_POST["txtdepartment_name"])."')"; 
        $insertresult=mysqli_query($con,$sqlinsert) or die("SQL insert error".mysqli_error($con));
        if($insertresult)
        {
            echo'<script> alert(" Record inserted successfully."); window.location.href="index.php?page=department.php&option=add" </script>';
        }
    }
// Insert code end
//Update code start
if(isset($_POST["btnupdate"]))
    {
    $department_id=$_POST['txtdepartment_id'];
    $sqlupdate="UPDATE department SET
                department_name='".mysqli_real_escape_string($con,$_POST["txtdepartment_name"])."'
                WHERE department_id='$department_id'";

    $resultupdate=mysqli_query($con,$sqlupdate) or die(mysqli_error($con));

    echo'<script>alert("Record Updated Successfully");window.location.href="index.php?page=department.php&option=view"</script>';
    }
// Update code end
?>
<script>
    ...
    if(isset($_GET["option"])) 
       {
        if($_GET["option"]=="add")
                                            ...
                                            <div class="all-form-element-inner">
                                                ...
                                                <!-- One Row Start-->
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <?php
                                                                $sql_generatedid="SELECT department_id FROM department ORDER BY department_id DESC LIMIT 1";
                                                                ...
                                                                if(mysqli_num_rows($result_generatedid)==1)
                                                                    ...
                                                                    $generatedid=++$row_generatedid["department_id"];
                                                                    }
                                                                else
                                                                    { //for first time
                                                                    $generatedid="DEPT01";
                                                                ...
                                                                ?>
                                                                <input type="text" name="txtdepartment_id" id="txtdepartment_id" class="form-control" value="<?php echo $generatedid; ?>" readonly required />
                                                            </div>
                                                            <!-- One Column End--> 
                                                            <!-- One Column Start-->
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <!-- Button Start--> 
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <center>
                                                                <a href="index.php?page=department.php&option=view"><input type="button" name="btngoback" id="btngoback" class="btn btn-primary" value="Go Back" /></a> 
                        ...
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">   
                                    <a href="index.php?page=department.php&option=add"><button class="btn btn-primary">Add Department</button></a>                                 
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="false" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                <th data-field="department_id  ">Department ID</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlview="SELECT department_id,department_name From department";
                                            $resultview=mysqli_query($con,$sqlview) or die("SQL view error".mysqli_error($con));
                                            while($rowview=mysqli_fetch_assoc($resultview))
                                                {                                                    
                                                    echo'<tr>';
                                                    echo'<td>'.$rowview["department_id"].'</td>';
                                                    echo'<td>'.$rowview["department_name"].'</td>';
                                                    echo'<td>';                                                    
                                                    echo'<a href="index.php?page=department.php&option=fullview&pk_department_id='.$rowview["department_id"].'"><button class="btn btn-success">View</button></a> ';
                                                    echo'<a href="index.php?page=department.php&option=edit&pk_department_id='.$rowview["department_id"].'"><button class="btn btn-info">Edit</button></a> ';
                                                    echo'<a onclick="return deletedata()" href="index.php?page=department.php&option=delete&pk_department_id='.$rowview["department_id"].'"><button class="btn btn-danger">Delete</button></a> ';
                                                    echo'</td>';
                                                    echo'</tr>';
                                                }
                                            ?>
            ...
            {
                $department_id=$_GET["pk_department_id"];

                $sqlview="SELECT * FROM department WHERE department_id='$department_id'";
                                    ...
                                    <div class="sparkline8-list">
                                        ...
                                        <div class="sparkline8-graph">
                                            <div class="static-table-list">
                                                <table class="table">                                        
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $rowview["department_id"]; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>Department Name</b></td>
                                                            <td><?php echo $rowview["department_name"]; ?></td>
                                                        </tr>
                                                ...
                                                <a href="index.php?page=department.php&option=view">
                                                <button class="btn btn-warning">Back</button>
                                                </a>     
                                                <?php
                                                if(!isset($_GET['print']))
                                                {
                                                echo '<a href="print.php?department_id='.$rowview["department_id"].'" target="_blank">
                                                ...
                                                <!-- One Row Start-->
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <input type="text" name="txtdepartment_id" id="txtdepartment_id" class="form-control" value="<?php echo $rowview['department_id']; ?>" readonly required />
                                                            </div>
                                                            <!-- One Column End--> 
                                                            <!-- One Column Start-->
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            ...
            {
            $staffid=$_GET["pk_department_id"];
                $sqldelete="DELETE FROM department WHERE department_id='$staffid'";
                $resultdelete=mysqli_query($con,$sqldelete) or die(mysqli_error($con));

            if($resultdelete)
            {
                echo'<script>alert("Record Deleted Successfully");window.location.href="index.php?page=department.php&option=view";</script>';
            } 
            }
       }
       ?>
