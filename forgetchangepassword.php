...
if(isset($_SESSION["forgetchange_user_name"]))
{
include("config.php");
$enterusername=$_SESSION["forgetchange_user_name"];
    ...
    if($newpassword==$confirmnewpassword)
      {
        ...
        unset($_SESSION["forgetchange_user_name"]);
        ...
        echo '<script>alert("Passwords do not match. Please verify and try again");</script>';
      }
  }
?>
	...
	<div class="error-pagewrap">
		<div class="error-page-int">
			<div class="text-center m-b-md custom-login">
				<h3>PLEASE ENTER YOUR FORGETCHANGE PASSWORD TO e-LMSL</h3>
			</div>
                    ...
                    <div class="panel-body">
                        <form action="" id="loginForm" onsubmit="return check_password()" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="" title="Please enter you username" required="" value="<?php echo $enterusername ?>" name="txtuser_name" id="txtuser_name" class="form-control" readonly >
