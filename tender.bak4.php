...
document.querySelectorAll("input[name='txttender_type']").forEach(el => {
    el.addEventListener("change", function(){
        ...
        if(type === "Sales"){
            document.getElementById("txttender_ref_no").value = "LMS/MKT/TDR/" + yearShort + "/XX";
        } else {
            document.getElementById("txttender_ref_no").value = "LMSL/SUP/DPC/XX/" + yearFull;
        }
    });
});
</script>