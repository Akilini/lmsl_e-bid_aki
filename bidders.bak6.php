...
if(isset($_POST["btnsave"]))
{
    ...
    {
        $file_name = $_FILES["txtbusiness_registration_copy"]["name"];
        ...
        {
            // unique file name
            $business_registration_copy = time() . "_BR_" . basename($file_name);

            move_uploaded_file($tmp_name, $business_dir . $business_registration_copy);
        }
        else
        {
            echo "<script>alert('Invalid Business Registration file type');</script>";
            exit();
        }
    }
    ...
    {
        $file_name = $_FILES["txtvat_registration_copy"]["name"];
        ...
        if(in_array($ext, $allowed))
        {
            $vat_registration_copy = time() . "_VAT_" . basename($file_name);

            move_uploaded_file($tmp_name, $vat_dir . $vat_registration_copy);
        }
        else
        {
            echo "<script>alert('Invalid VAT file type');</script>";
            exit();
        }
    }
    ...
    (user_id,user_name,password,usertype,attempt,otp,status)
    VALUES(
    '$bidder_id',
    '".mysqli_real_escape_string($con,$_POST["txtemail"])."',
    '$password',
    ...
    mysqli_query($con,$sqlinsertlogin);

    echo '<script>alert("Record inserted successfully");window.location.href="index.php?page=bidders.php&option=view";</script>';
}
// Insert code end
                                                ...
                                                <table class="table">                                        
                                                    <tbody>                                                      
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $rowview["business_registration_copy"]; ?></td>
                                                            <td>
                                                                <?php
                                                                if(!empty($rowview["business_registration_copy"]))
                                                                {
                                                                    ?>
                                                                    <a href="bidder/business_registration_copy/<?php echo $rowview["business_registration_copy"]; ?>" target="_blank">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $rowview["vat_registration_copy"]; ?></td>
                                                            <td>
                                                                <?php
                                                                if(!empty($rowview["vat_registration_copy"]))
                                                                {
                                                                    ?>
                                                                    <a href="bidder/vat_registration_copy/<?php echo $rowview["vat_registration_copy"]; ?>" target="_blank">
                                                                        <button class="btn btn-primary" type="button">View</button>
                                                                    </a>
                                                                    <?php
                                                                }
