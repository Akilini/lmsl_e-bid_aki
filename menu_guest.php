<ul class="metismenu" id="menu1">
    ...
    <li>
        <a title="Landing Page" href="events.html" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">About US</span></a>
    </li>
	<li>
        <a title="Landing Page" href="events.html" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Bids</span></a>
    </li>
	<li>
        <a title="Landing Page" href="events.html" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Tender</span></a>
    </li>
    <li>
        <a class="has-arrow" href="all-professors.html" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Register</span></a>
        <ul class="submenu-angle" aria-expanded="false">
            <li><a title="Add Professor" href="index.php?page=bidders.php&option=view"><span class="mini-sub-pro">Bidder Registration</span></a></li>
            <li><a title="Add Professor" href="index.php?page=proprietor.php&option=view"><span class="mini-sub-pro">Proprietor Registration</span></a></li>
            </ul>
    </li>
	<li>
        <a title="Landing Page" href="index.php?page=login.php" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Login</span></a>
    </li>
    <!--<li>
